...
- [How to add 3rd party spaceport modules/expansion cards/etc](#how-to-add-3rd-party-spaceport-modulesexpansion-cardsetc)
	- [SECTION 1: Overriding scripted_effects/triggers (objects)](#section-1-overriding-scripted_effectstriggers-objects)
	- [SECTION 2: Adding a new Expansion Card](#section-2-adding-a-new-expansion-card)
	- [SECTION 3: Adding support for your own Spaceport Module](#section-3-adding-support-for-your-own-spaceport-module)
	- [SECTION 4: Adding support for your spaceport extension mod](#section-4-adding-support-for-your-spaceport-extension-mod)
